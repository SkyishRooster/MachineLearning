---
title: "01_False_Discovery_Control"
author: "Ashley"
date: "2023-01-08"
...
## 5. Predict and examine the number of significant variables
Theoretically speaking, based on how the data was generated, 0 significant variable is expected because it's a regression of white noise on white noise. But in terms of hypothesis testing attribute, since the data was totally randomly generated, 1000*alpha significant variables are expected, i.e. if alpha = 0.01 then there will expect to be 10 significant variables. 
```{r}
...
## 6. Given the p values, use the BH procedure to control the FDR with a q of 0.1.
```{r}
...
## 7. Explore the “01_autos.csv” data
```{r}
...
## 10. Use the BH procedure to control the FDR with a q of 0.1. Plot the cutoff line together with the significant and insignificant p-values.
```{r}
