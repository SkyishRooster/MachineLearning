...
```{r}
setwd("C:/UCD/__WINTER SESSION/452 Machine Learning/Assignment 3 Cross Validation & Lasso")
...
#### **a) Fit a Lasso regression to predict the heart attack probability. Use cross-validation to obtain lambda_min as well as lambda_1se. Explain the two resulting models. Which one would you choose?**
```{r}
